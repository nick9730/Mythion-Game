...
void UM_LevelUpExecution::Execute_Implementation(const FGameplayEffectCustomExecutionParameters &ExecutionParams,
                                                 FGameplayEffectCustomExecutionOutput &OutExecutionOutput) const
{
    ...
    while (CurrentXP >= XpMax)
    {
        ...
        if (IsValid(Character) && Character->LevelUpStats)
        {
            ...
            FGameplayEffectSpecHandle SpecHandle =
                ASC->MakeOutgoingSpec(Character->LevelUpStats, CurrentLevel, EffectContext);
    ...
    OutExecutionOutput.AddOutputModifier(
        FGameplayModifierEvaluatedData(UM_AttributeSet::GetXpAttribute(), EGameplayModOp::Override, CurrentXP));
    OutExecutionOutput.AddOutputModifier(
        FGameplayModifierEvaluatedData(UM_AttributeSet::GetLevelAttribute(), EGameplayModOp::Override, CurrentLevel));
    OutExecutionOutput.AddOutputModifier(
        FGameplayModifierEvaluatedData(UM_AttributeSet::GetXpMaxAttribute(), EGameplayModOp::Override, XpMax));
}
